...
describe 'Resource operations', type: :request, pundit: "2.0" do
  ...
  describe 'GET api/v1/articles' do
    subject(:last_response) { get('api/v1/articles') }
  ...
  describe 'GET api/v1/articles/:id' do
    subject(:last_response) { get("api/v1/articles/#{article.external_id}") }
  ...
  describe 'DELETE api/v1/articles/:id' do
    subject(:last_response) { delete("api/v1/articles/#{article.external_id}") }
    let(:policy_scope) { Article.all }
