...
RSpec.describe 'Related resources operations', type: :request, pundit: "2.0" do
  ...
  describe 'GET api/v1/articles/:id/comments' do
    subject(:last_response) { get("api/v1/articles/#{article.external_id}/comments") }
  ...
  describe 'GET api/v1/articles/:id/author' do
    subject(:last_response) { get("api/v1/articles/#{article.external_id}/author") }
